/**
 * v0 by Vercel.
 * @see https://v0.dev/t/UZTIDBP15sy
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-4 bg-gray-100">
        ...
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl pt-4">Your Class Credits</h1>
          <p className="mt-4 text-muted-foreground">Keep track of your remaining class credits.</p>
        </div>
        <div className="rounded-lg bg-card p-6 shadow-sm">
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row">
            <div>
              <p className="text-2xl font-bold text-foreground">
                <span className="text-4xl">1</span> Credits
              </p>
          ...
          <div className="mt-4 flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between">
              <p className="text-muted-foreground">Monday, Wednesday 9am-10:30am</p>
            </div>
          </div>
          {12 < 2 && (
