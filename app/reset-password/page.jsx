                            ...
                            <>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="password" type="password" placeholder="Enter your Student&#39;s First Name" value={password} onChange={(e) => setPassword(e.target.value)} />
                                    </div>
                                    <div className="grid gap-2">
                                        <Label htmlFor="email">Confirm New Password</Label>
                                        <Input id="confirm password" type="password" placeholder="Enter your Student&#39;s Last Name" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                                    </div>
