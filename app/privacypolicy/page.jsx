...
const Page = () => {
	return (
		<body>
			...
			<p>This privacy notice for Class Access (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), describes how and why we might collect, store, use, and/or share (&quot;process&quot;) your information when you use our services (&quot;Services&quot;), such as when you:</p>
			<ul>
				<li>Visit our website at <a href="http://www.classaccess.tech">http://www.classaccess.tech</a>, or any website of ours that links to this privacy notice</li>
				<li>Engage with us in other related ways, including any sales, marketing, or events</li>
			</ul>
			<p>Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:myclassaccess@gmail.com">myclassaccess@gmail.com</a>.</p>
			...
			<ol>
				...
				<li><a href="#section12">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
			...
			<ul>
				...
				<li><strong>To send you marketing and promotional communications.</strong> We may process the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. You can opt out of our marketing emails at any time. For more information, see &quot&quot&quot;WHAT ARE YOUR PRIVACY RIGHTS?&quot&quot&quot; below.</li>
				...
				<li><strong>To comply with our legal obligations.</strong> We may process your information to comply with our legal obligations, respond to legal requests, and prevent harm.</li>
			</ul>
			...
			<p><strong>European Union (EU) General Data Protection Regulation (GDPR)</strong></p>
			<p>The GDPR requires us to explain the valid legal bases we rely on in order to process your personal information. As such, we may rely on the following legal bases to process your personal information:</p>
			<ul>
			...
			<p>If you are located in California, this section applies to you.</p>
			<p>The CCPA requires us to explain the categories of personal information we collect and the purposes for which we use each category. In the past twelve months, we have collected the following categories of personal information:</p>
			<ul>
				...
				<li><strong>Internet or other similar network activity.</strong> Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements.</li>
				<li><strong>Geolocation data.</strong> Device location.</li>
				<li><strong>Audio, electronic, visual, thermal, olfactory, or similar information.</strong> Images and audio, video or call recordings created in connection with our business activities.</li>
				<li><strong>Professional or employment-related information.</strong> Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us.</li>
			...
			<ul>
				<li><strong>Category A -  Identifiers.</strong> Until the user withdraws consent.</li>
				<li><strong>Category B -  Personal information categories listed in the California Customer Records statute.</strong> Until the user withdraws consent.</li>
				<li><strong>Category C -  Protected classification characteristics under California or federal law.</strong> Until the user withdraws consent.</li>
				<li><strong>Category D -  Commercial information.</strong> Until the user withdraws consent.</li>
				<li><strong>Category E -  Biometric information.</strong> Until the user withdraws consent.</li>
				<li><strong>Category F -  Internet or other similar network activity.</strong> Until the user withdraws consent.</li>
				<li><strong>Category G -  Geolocation data.</strong> Until the user withdraws consent.</li>
				<li><strong>Category H -  Audio, electronic, visual, thermal, olfactory, or similar information.</strong> Until the user withdraws consent.</li>
				<li><strong>Category I -  Professional or employment-related information.</strong> Until the user withdraws consent.</li>
				<li><strong>Category J -  Education Information.</strong> Until the user withdraws consent.</li>
				<li><strong>Category K - Inferences drawn from other personal information.</strong> Until the user withdraws consent.</li>
			</ul>
			...
			<p>You may contact us by email at [contact@example.com], or by referring to the contact details at the bottom of this document.</p>
			...
			<p>[Class Access] has not disclosed or sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. [Class Access] will not sell personal information in the future belonging to website visitors, users, and other consumers.</p>
			...
			<ul>
				...
				<li><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g., Google Maps API, Place API). We obtain and store on your device (&apos;cache&apos;) your location for six (6) months. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document.</li>
			...
			<h2 id="section11">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h2>
			...
			<h2 id="section13">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
			<p>If you have questions or comments about this notice, you may email us at sreevikram.r@gmail.com</p>

			<h2 id="section14">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
			<p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please contact us at sreevikram.r@gmail.com</p>
		</body>
	)
}
