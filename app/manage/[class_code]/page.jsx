            ...
            <main className="p-6 space-y-8">
                ...
                <div className="w-full grid grid-cols-2">
                    <section className="space-y-1">
                        <h1 className="text-3xl font-bold">{classData && classData[0] ? classData[0].name : 'Class Name'}</h1>
                        <p className="font-medium pt-4">{classData && classData[0] ? classData[0].description : 'No description available'}</p>
                    </section>
                ...
                Add Students
                    ...
                    <div className="mt-4 overflow-x-auto bg-background rounded-lg border p-4">
                        <Table>
                            ...
                            <TableBody>
                                {/* Student data will be populated here later */}
                                <TableRow>
